class LightningUiKit::PaginationComponent < LightningUiKit::BaseComponent
  ...
  def link_classes
    "lui:min-w-10 lui:h-10 lui:sm:min-w-9 lui:sm:h-9 lui:flex lui:items-center lui:justify-center lui:rounded-lg lui:border lui:text-base/6 lui:font-semibold lui:sm:text-sm/6 \
